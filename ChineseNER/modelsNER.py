...
class BiLSTM_CRF(nn.Module):
    def __init__(self, batch_size, vocab_size, tag_to_ix, embedding_dim, hidden_dim):
        ...
        t = torch.randn(batch_size, self.tagset_size, self.tagset_size)
